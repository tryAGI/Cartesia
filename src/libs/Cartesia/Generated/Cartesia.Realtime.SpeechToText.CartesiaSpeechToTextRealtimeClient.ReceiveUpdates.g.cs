...
namespace Cartesia.Realtime.SpeechToText
{
    public sealed partial class CartesiaSpeechToTextRealtimeClient
    {
        ...
        public async global::System.Collections.Generic.IAsyncEnumerable<global::Cartesia.Realtime.SpeechToText.ServerEvent> ReceiveUpdatesAsync(
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            while (_clientWebSocket.State == global::System.Net.WebSockets.WebSocketState.Open)
            {
                ...
                string json = global::System.Text.Encoding.UTF8.GetString(__messageBuffer.ToArray());
                    global::Cartesia.Realtime.SpeechToText.ServerEvent @event;
                    try
                    {
                        @event = (global::Cartesia.Realtime.SpeechToText.ServerEvent)global::System.Text.Json.JsonSerializer.Deserialize(json, typeof(global::Cartesia.Realtime.SpeechToText.ServerEvent), JsonSerializerContext)!;
                    }
            ...
            string rawText)
        {
            ...
            MessageReceived?.Invoke(
                this,
                new AutoSDKWebSocketMessageEventArgs<global::Cartesia.Realtime.SpeechToText.ServerEvent>(
                    @event,
                    rawText,
                    json));

            if (@event.Transcript is { } __STTTranscriptResponseReceived)
            {
                STTTranscriptResponseReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Cartesia.Realtime.SpeechToText.STTTranscriptResponse>(
                        __STTTranscriptResponseReceived,
                        rawText,
                        json));
            }
            if (@event.FlushDone is { } __STTFlushDoneResponseReceived)
            {
                STTFlushDoneResponseReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Cartesia.Realtime.SpeechToText.STTFlushDoneResponse>(
                        __STTFlushDoneResponseReceived,
                        rawText,
                        json));
            }
            if (@event.Done is { } __STTDoneResponseReceived)
            {
                STTDoneResponseReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Cartesia.Realtime.SpeechToText.STTDoneResponse>(
                        __STTDoneResponseReceived,
                        rawText,
                        json));
            }
            if (@event.Error is { } __STTErrorResponseReceived)
            {
                STTErrorResponseReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Cartesia.Realtime.SpeechToText.STTErrorResponse>(

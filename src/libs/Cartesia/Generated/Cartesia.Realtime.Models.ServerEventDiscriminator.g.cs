...
namespace Cartesia.Realtime
{
    ...
    public sealed partial class ServerEventDiscriminator
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Cartesia.Realtime.JsonConverters.ServerEventDiscriminatorTypeJsonConverter))]
        public global::Cartesia.Realtime.ServerEventDiscriminatorType? Type { get; set; }

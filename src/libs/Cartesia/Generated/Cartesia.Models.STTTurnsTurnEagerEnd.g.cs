...
namespace Cartesia
{
    ...
    public sealed partial class STTTurnsTurnEagerEnd
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Cartesia.JsonConverters.STTTurnsTurnEagerEndTypeJsonConverter))]
        public global::Cartesia.STTTurnsTurnEagerEndType Type { get; set; }
        ...
        public STTTurnsTurnEagerEnd(
            string transcript,
            string requestId,
            global::Cartesia.STTTurnsTurnEagerEndType type)
        {
            this.Type = type;

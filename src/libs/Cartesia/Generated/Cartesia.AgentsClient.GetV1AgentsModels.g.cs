...
namespace Cartesia
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement s_GetV1AgentsModelsSecurityRequirement0 =
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement[] s_GetV1AgentsModelsSecurityRequirements =
            new global::Cartesia.EndPointSecurityRequirement[]
            {                s_GetV1AgentsModelsSecurityRequirement0,
            };
        partial void PrepareGetV1AgentsModelsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? startingAfter,
            ref string? endingBefore,
            ref int? limit,
            ref global::Cartesia.GetV1AgentsModelsCartesiaVersion cartesiaVersion);
        partial void PrepareGetV1AgentsModelsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? startingAfter,
            string? endingBefore,
            int? limit,
            global::Cartesia.GetV1AgentsModelsCartesiaVersion cartesiaVersion);
        partial void ProcessGetV1AgentsModelsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetV1AgentsModelsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.ListManagedAgentModelsV1Response> GetV1AgentsModelsAsync(
        ...
        {
            var __response = await GetV1AgentsModelsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Cartesia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Cartesia.AutoSDKHttpResponse<global::Cartesia.ListManagedAgentModelsV1Response>> GetV1AgentsModelsAsResponseAsync(
            string? startingAfter = default,
            string? endingBefore = default,
            int? limit = default,
            global::Cartesia.GetV1AgentsModelsCartesiaVersion cartesiaVersion = global::Cartesia.GetV1AgentsModelsCartesiaVersion.x20260814,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetV1AgentsModelsArguments(
            ...
            var __authorizations = global::Cartesia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetV1AgentsModelsSecurityRequirements,
                operationName: "GetV1AgentsModelsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetV1AgentsModelsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Cartesia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetV1AgentsModelsAsync",
                                pathTemplate: "\"/v1/agents/models\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetV1AgentsModelsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetV1AgentsModelsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Cartesia.ListManagedAgentModelsV1Response.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Cartesia.AutoSDKHttpResponse<global::Cartesia.ListManagedAgentModelsV1Response>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Cartesia.ListManagedAgentModelsV1Response.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??

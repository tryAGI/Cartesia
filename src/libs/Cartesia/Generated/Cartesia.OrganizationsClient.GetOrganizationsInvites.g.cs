...
namespace Cartesia
{
    public partial class OrganizationsClient
    {
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement s_GetOrganizationsInvitesSecurityRequirement0 =
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement[] s_GetOrganizationsInvitesSecurityRequirements =
            new global::Cartesia.EndPointSecurityRequirement[]
            {                s_GetOrganizationsInvitesSecurityRequirement0,
            };
        partial void PrepareGetOrganizationsInvitesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? limit,
            ref string? startingAfter,
            ref string? endingBefore,
            ref global::Cartesia.GetOrganizationsInvitesStatus? status,
            ref global::Cartesia.GetOrganizationsInvitesCartesiaVersion cartesiaVersion);
        partial void PrepareGetOrganizationsInvitesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? limit,
            string? startingAfter,
            string? endingBefore,
            global::Cartesia.GetOrganizationsInvitesStatus? status,
            global::Cartesia.GetOrganizationsInvitesCartesiaVersion cartesiaVersion);
        partial void ProcessGetOrganizationsInvitesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetOrganizationsInvitesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.GetOrganizationsInvitesResponse> GetOrganizationsInvitesAsync(
            int? limit = default,
        ...
        {
            var __response = await GetOrganizationsInvitesAsResponseAsync(
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Cartesia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Cartesia.AutoSDKHttpResponse<global::Cartesia.GetOrganizationsInvitesResponse>> GetOrganizationsInvitesAsResponseAsync(
            int? limit = default,
            string? startingAfter = default,
            string? endingBefore = default,
            global::Cartesia.GetOrganizationsInvitesStatus? status = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetOrganizationsInvitesArguments(
            ...
            var __authorizations = global::Cartesia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetOrganizationsInvitesSecurityRequirements,
                operationName: "GetOrganizationsInvitesAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetOrganizationsInvitesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Cartesia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetOrganizationsInvitesAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetOrganizationsInvitesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Cartesia.ListInvitesBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Cartesia.ListInvitesBadRequestError.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Cartesia.ApiException<global::Cartesia.ListInvitesBadRequestError?>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetOrganizationsInvitesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Cartesia.GetOrganizationsInvitesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Cartesia.AutoSDKHttpResponse<global::Cartesia.GetOrganizationsInvitesResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Cartesia.GetOrganizationsInvitesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??

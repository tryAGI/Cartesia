...
{
    /// <inheritdoc />
    public class TTSWebSocketRequestJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Cartesia.TTSWebSocketRequest>
    {
        /// <inheritdoc />
        public override global::Cartesia.TTSWebSocketRequest Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::Cartesia.GenerationRequest? generationRequest = default;
            global::Cartesia.CancelContextRequest? cancelContextRequest = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::Cartesia.TTSWebSocketRequest(
                generationRequest,
        ...
        public override void Write(
            ...
            global::Cartesia.TTSWebSocketRequest value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

...
namespace Cartesia
{
    public partial class OrganizationsClient
    {
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement s_GetOrganizationsUsersSecurityRequirement0 =
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement[] s_GetOrganizationsUsersSecurityRequirements =
            new global::Cartesia.EndPointSecurityRequirement[]
            {                s_GetOrganizationsUsersSecurityRequirement0,
            };
        partial void PrepareGetOrganizationsUsersArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? limit,
            ref string? startingAfter,
            ref string? endingBefore,
            ref string? q,
            ref global::Cartesia.GetOrganizationsUsersCartesiaVersion cartesiaVersion);
        partial void PrepareGetOrganizationsUsersRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? endingBefore,
            string? q,
            global::Cartesia.GetOrganizationsUsersCartesiaVersion cartesiaVersion);
        partial void ProcessGetOrganizationsUsersResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetOrganizationsUsersResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.GetOrganizationsUsersResponse> GetOrganizationsUsersAsync(
            int? limit = default,
        ...
        {
            var __response = await GetOrganizationsUsersAsResponseAsync(
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Cartesia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Cartesia.AutoSDKHttpResponse<global::Cartesia.GetOrganizationsUsersResponse>> GetOrganizationsUsersAsResponseAsync(
            int? limit = default,
            string? startingAfter = default,
            string? endingBefore = default,
            string? q = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetOrganizationsUsersArguments(
            ...
            var __authorizations = global::Cartesia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetOrganizationsUsersSecurityRequirements,
                operationName: "GetOrganizationsUsersAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetOrganizationsUsersRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Cartesia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetOrganizationsUsersAsync",
                                pathTemplate: "\"/organizations/users\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetOrganizationsUsersResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Cartesia.ListUsersBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Cartesia.ListUsersBadRequestError.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Cartesia.ApiException<global::Cartesia.ListUsersBadRequestError?>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetOrganizationsUsersResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Cartesia.GetOrganizationsUsersResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Cartesia.AutoSDKHttpResponse<global::Cartesia.GetOrganizationsUsersResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Cartesia.GetOrganizationsUsersResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??

...
namespace Cartesia
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement s_GetV1AgentsByAgentIdVersionsSecurityRequirement0 =
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement[] s_GetV1AgentsByAgentIdVersionsSecurityRequirements =
            new global::Cartesia.EndPointSecurityRequirement[]
            {                s_GetV1AgentsByAgentIdVersionsSecurityRequirement0,
            };
        partial void PrepareGetV1AgentsByAgentIdVersionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string agentId,
            ref string? startingAfter,
            ref string? endingBefore,
            ref int? limit,
            ref global::Cartesia.GetV1AgentsByAgentIdVersionsCartesiaVersion cartesiaVersion);
        partial void PrepareGetV1AgentsByAgentIdVersionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? endingBefore,
            int? limit,
            global::Cartesia.GetV1AgentsByAgentIdVersionsCartesiaVersion cartesiaVersion);
        partial void ProcessGetV1AgentsByAgentIdVersionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetV1AgentsByAgentIdVersionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.ListManagedAgentVersionsV1Response> GetV1AgentsByAgentIdVersionsAsync(
            string agentId,
            string? startingAfter = default,
            string? endingBefore = default,
            int? limit = default,
            global::Cartesia.GetV1AgentsByAgentIdVersionsCartesiaVersion cartesiaVersion = global::Cartesia.GetV1AgentsByAgentIdVersionsCartesiaVersion.x20260814,
            global::Cartesia.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetV1AgentsByAgentIdVersionsAsResponseAsync(
                agentId: agentId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Cartesia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Cartesia.AutoSDKHttpResponse<global::Cartesia.ListManagedAgentVersionsV1Response>> GetV1AgentsByAgentIdVersionsAsResponseAsync(
            string agentId,
            string? startingAfter = default,
            string? endingBefore = default,
            int? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetV1AgentsByAgentIdVersionsArguments(
            ...
            var __authorizations = global::Cartesia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetV1AgentsByAgentIdVersionsSecurityRequirements,
                operationName: "GetV1AgentsByAgentIdVersionsAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Cartesia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetV1AgentsByAgentIdVersions",
                                methodName: "GetV1AgentsByAgentIdVersionsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetV1AgentsByAgentIdVersionsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::Cartesia.PublicErrorResponse? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::Cartesia.PublicErrorResponse.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Cartesia.ApiException<global::Cartesia.PublicErrorResponse>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetV1AgentsByAgentIdVersionsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Cartesia.ListManagedAgentVersionsV1Response.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Cartesia.AutoSDKHttpResponse<global::Cartesia.ListManagedAgentVersionsV1Response>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Cartesia.ListManagedAgentVersionsV1Response.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??

...
namespace Cartesia
{
    public partial class PhoneNumbersClient
    {
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement s_PhoneNumbersListSecurityRequirement0 =
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement[] s_PhoneNumbersListSecurityRequirements =
            new global::Cartesia.EndPointSecurityRequirement[]
            {                s_PhoneNumbersListSecurityRequirement0,
            };
        partial void PreparePhoneNumbersListArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Cartesia.PhoneNumbersListCartesiaVersion cartesiaVersion,
            ref string? agentId,
            ref string? providerId,
            ref global::Cartesia.PhoneNumbersListType? type,
            ref string? q,
            ref string? startingAfter,
            ref string? endingBefore,
            ref int? limit);
        partial void PreparePhoneNumbersListRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Cartesia.PhoneNumbersListCartesiaVersion cartesiaVersion,
            string? agentId,
            string? providerId,
            global::Cartesia.PhoneNumbersListType? type,
            string? q,
            string? startingAfter,
            string? endingBefore,
            int? limit);
        partial void ProcessPhoneNumbersListResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPhoneNumbersListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        ///   -d limit=10
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Cartesia.PhoneNumbersListResponse> PhoneNumbersListAsync(
        ...
        {
            var __response = await PhoneNumbersListAsResponseAsync(
        ...
        ///   -d limit=10
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Cartesia.AutoSDKHttpResponse<global::Cartesia.PhoneNumbersListResponse>> PhoneNumbersListAsResponseAsync(
            global::Cartesia.PhoneNumbersListCartesiaVersion cartesiaVersion = global::Cartesia.PhoneNumbersListCartesiaVersion.x20260814,
            string? agentId = default,
            string? providerId = default,
            global::Cartesia.PhoneNumbersListType? type = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PreparePhoneNumbersListArguments(
            ...
            var __authorizations = global::Cartesia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PhoneNumbersListSecurityRequirements,
                operationName: "PhoneNumbersListAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePhoneNumbersListRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Cartesia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PhoneNumbersListAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPhoneNumbersListResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPhoneNumbersListResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Cartesia.PhoneNumbersListResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Cartesia.AutoSDKHttpResponse<global::Cartesia.PhoneNumbersListResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Cartesia.PhoneNumbersListResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??

...
namespace Cartesia
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement s_AgentsRetryCallBatchSecurityRequirement0 =
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement[] s_AgentsRetryCallBatchSecurityRequirements =
            new global::Cartesia.EndPointSecurityRequirement[]
            {                s_AgentsRetryCallBatchSecurityRequirement0,
            };
        partial void PrepareAgentsRetryCallBatchArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Cartesia.AgentsRetryCallBatchCartesiaVersion cartesiaVersion,
            ref string batchId);
        partial void PrepareAgentsRetryCallBatchRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Cartesia.AgentsRetryCallBatchCartesiaVersion cartesiaVersion,
            string batchId);
        partial void ProcessAgentsRetryCallBatchResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentsRetryCallBatchResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.AgentCallBatch> AgentsRetryCallBatchAsync(
            string batchId,
        ...
        {
            var __response = await AgentsRetryCallBatchAsResponseAsync(
                batchId: batchId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Cartesia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Cartesia.AutoSDKHttpResponse<global::Cartesia.AgentCallBatch>> AgentsRetryCallBatchAsResponseAsync(
            string batchId,
            global::Cartesia.AgentsRetryCallBatchCartesiaVersion cartesiaVersion = global::Cartesia.AgentsRetryCallBatchCartesiaVersion.x20260814,
            global::Cartesia.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAgentsRetryCallBatchArguments(
            ...
            var __authorizations = global::Cartesia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AgentsRetryCallBatchSecurityRequirements,
                operationName: "AgentsRetryCallBatchAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Cartesia.PathBuilder(
                                path: $"/agents/calls/batches/{batchId}/retry",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAgentsRetryCallBatchRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Cartesia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AgentsRetryCallBatch",
                                methodName: "AgentsRetryCallBatchAsync",
                                pathTemplate: "$\"/agents/calls/batches/{batchId}/retry\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAgentsRetryCallBatchResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAgentsRetryCallBatchResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);

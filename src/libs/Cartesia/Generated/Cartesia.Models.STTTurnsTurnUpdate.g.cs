...
namespace Cartesia
{
    ...
    public sealed partial class STTTurnsTurnUpdate
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Cartesia.JsonConverters.STTTurnsTurnUpdateTypeJsonConverter))]
        public global::Cartesia.STTTurnsTurnUpdateType Type { get; set; }
        ...
        public STTTurnsTurnUpdate(
            string transcript,
            string requestId,
            global::Cartesia.STTTurnsTurnUpdateType type)
        {
            this.Type = type;

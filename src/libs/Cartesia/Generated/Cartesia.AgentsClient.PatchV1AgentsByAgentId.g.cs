...
namespace Cartesia
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement s_PatchV1AgentsByAgentIdSecurityRequirement0 =
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement[] s_PatchV1AgentsByAgentIdSecurityRequirements =
            new global::Cartesia.EndPointSecurityRequirement[]
            {                s_PatchV1AgentsByAgentIdSecurityRequirement0,
            };
        partial void PreparePatchV1AgentsByAgentIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string agentId,
            ref global::Cartesia.PatchV1AgentsByAgentIdCartesiaVersion cartesiaVersion,
            global::Cartesia.UpdateManagedAgentV1Request request);
        partial void PreparePatchV1AgentsByAgentIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string agentId,
            global::Cartesia.PatchV1AgentsByAgentIdCartesiaVersion cartesiaVersion,
            global::Cartesia.UpdateManagedAgentV1Request request);
        partial void ProcessPatchV1AgentsByAgentIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPatchV1AgentsByAgentIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.ManagedAgentV1> PatchV1AgentsByAgentIdAsync(
            string agentId,
        ...
        {
            var __response = await PatchV1AgentsByAgentIdAsResponseAsync(
                agentId: agentId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Cartesia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Cartesia.AutoSDKHttpResponse<global::Cartesia.ManagedAgentV1>> PatchV1AgentsByAgentIdAsResponseAsync(
            string agentId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePatchV1AgentsByAgentIdArguments(
            ...
            var __authorizations = global::Cartesia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PatchV1AgentsByAgentIdSecurityRequirements,
                operationName: "PatchV1AgentsByAgentIdAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePatchV1AgentsByAgentIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Cartesia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PatchV1AgentsByAgentId",
                                methodName: "PatchV1AgentsByAgentIdAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPatchV1AgentsByAgentIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPatchV1AgentsByAgentIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Cartesia.ManagedAgentV1.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Cartesia.AutoSDKHttpResponse<global::Cartesia.ManagedAgentV1>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Cartesia.ManagedAgentV1.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.ManagedAgentV1> PatchV1AgentsByAgentIdAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Cartesia.UpdateManagedAgentV1Request
            {
                Config = config,
            ...
            return await PatchV1AgentsByAgentIdAsync(
                agentId: agentId,
                cartesiaVersion: cartesiaVersion,
                request: __request,
                requestOptions: requestOptions,

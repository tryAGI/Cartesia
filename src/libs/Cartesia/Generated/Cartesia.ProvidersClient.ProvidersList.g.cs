...
namespace Cartesia
{
    public partial class ProvidersClient
    {
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement s_ProvidersListSecurityRequirement0 =
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement[] s_ProvidersListSecurityRequirements =
            new global::Cartesia.EndPointSecurityRequirement[]
            {                s_ProvidersListSecurityRequirement0,
            };
        partial void PrepareProvidersListArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Cartesia.ProvidersListCartesiaVersion cartesiaVersion,
            ref global::Cartesia.ProvidersListType? type,
            ref string? accountSid);
        partial void PrepareProvidersListRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Cartesia.ProvidersListCartesiaVersion cartesiaVersion,
            global::Cartesia.ProvidersListType? type,
            string? accountSid);
        partial void ProcessProvidersListResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProvidersListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::Cartesia.ProviderAccountResponse>> ProvidersListAsync(
        ...
        {
            var __response = await ProvidersListAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Cartesia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Cartesia.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Cartesia.ProviderAccountResponse>>> ProvidersListAsResponseAsync(
            global::Cartesia.ProvidersListCartesiaVersion cartesiaVersion = global::Cartesia.ProvidersListCartesiaVersion.x20260814,
            global::Cartesia.ProvidersListType? type = default,
            string? accountSid = default,
            global::Cartesia.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Cartesia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ProvidersListSecurityRequirements,
                operationName: "ProvidersListAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                ...
                                .AddOptionalParameter("account_sid", accountSid)
                                ;
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Cartesia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ProvidersListAsync",
                                pathTemplate: "\"/agents/phone-numbers/providers\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessProvidersListResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::Cartesia.ProviderAccountResponse>?)global::System.Text.Json.JsonSerializer.Deserialize(__content, typeof(global::System.Collections.Generic.IList<global::Cartesia.ProviderAccountResponse>), JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Cartesia.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Cartesia.ProviderAccountResponse>>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::Cartesia.ProviderAccountResponse>?)await global::System.Text.Json.JsonSerializer.DeserializeAsync(__content, typeof(global::System.Collections.Generic.IList<global::Cartesia.ProviderAccountResponse>), JsonSerializerContext).ConfigureAwait(false) ??

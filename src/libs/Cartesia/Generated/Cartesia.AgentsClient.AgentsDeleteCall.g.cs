...
namespace Cartesia
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement s_AgentsDeleteCallSecurityRequirement0 =
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement[] s_AgentsDeleteCallSecurityRequirements =
            new global::Cartesia.EndPointSecurityRequirement[]
            {                s_AgentsDeleteCallSecurityRequirement0,
            };
        partial void PrepareAgentsDeleteCallArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Cartesia.AgentsDeleteCallCartesiaVersion cartesiaVersion,
            ref string callId);
        partial void PrepareAgentsDeleteCallRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Cartesia.AgentsDeleteCallCartesiaVersion cartesiaVersion,
            string callId);
        partial void ProcessAgentsDeleteCallResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentsDeleteCallResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.AgentCall> AgentsDeleteCallAsync(
            string callId,
        ...
        {
            var __response = await AgentsDeleteCallAsResponseAsync(
                callId: callId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Cartesia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Cartesia.AutoSDKHttpResponse<global::Cartesia.AgentCall>> AgentsDeleteCallAsResponseAsync(
            string callId,
            global::Cartesia.AgentsDeleteCallCartesiaVersion cartesiaVersion = global::Cartesia.AgentsDeleteCallCartesiaVersion.x20260814,
            global::Cartesia.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAgentsDeleteCallArguments(
            ...
            var __authorizations = global::Cartesia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AgentsDeleteCallSecurityRequirements,
                operationName: "AgentsDeleteCallAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAgentsDeleteCallRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Cartesia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AgentsDeleteCall",
                                methodName: "AgentsDeleteCallAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAgentsDeleteCallResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAgentsDeleteCallResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Cartesia.AgentCall.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Cartesia.AutoSDKHttpResponse<global::Cartesia.AgentCall>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Cartesia.AgentCall.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??

...
namespace Cartesia
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Cartesia.AutoSDKRetryOptions Retry { get; set; } = new global::Cartesia.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Cartesia.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Cartesia.IAutoSDKHook>();
        ...
        public global::Cartesia.AutoSDKClientOptions AddHook(
            global::Cartesia.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Cartesia.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Cartesia.AutoSDKClientOptions UseAuthorizationProvider(
            global::Cartesia.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Cartesia.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Cartesia.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Cartesia.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Cartesia.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Cartesia.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Cartesia.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Cartesia.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Cartesia.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Cartesia.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Cartesia.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Cartesia.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Cartesia.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Cartesia.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Cartesia.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Cartesia.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Cartesia.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Cartesia.AutoSDKClientOptions clientOptions,
            global::Cartesia.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Cartesia.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Cartesia.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Cartesia.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Cartesia.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Cartesia.IAutoSDKHook, global::Cartesia.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Cartesia.AutoSDKHookContext context)
        {

...
namespace Cartesia
{
    public partial class PhoneNumbersClient
    {
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement s_PhoneNumbersProvisionSecurityRequirement0 =
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement[] s_PhoneNumbersProvisionSecurityRequirements =
            new global::Cartesia.EndPointSecurityRequirement[]
            {                s_PhoneNumbersProvisionSecurityRequirement0,
            };
        partial void PreparePhoneNumbersProvisionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Cartesia.PhoneNumbersProvisionCartesiaVersion cartesiaVersion,
            global::Cartesia.ProvisionPhoneNumberBody request);
        partial void PreparePhoneNumbersProvisionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Cartesia.PhoneNumbersProvisionCartesiaVersion cartesiaVersion,
            global::Cartesia.ProvisionPhoneNumberBody request);
        partial void ProcessPhoneNumbersProvisionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPhoneNumbersProvisionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.ProvisionPhoneNumberResponse> PhoneNumbersProvisionAsync(
        ...
        {
            var __response = await PhoneNumbersProvisionAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Cartesia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Cartesia.AutoSDKHttpResponse<global::Cartesia.ProvisionPhoneNumberResponse>> PhoneNumbersProvisionAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePhoneNumbersProvisionArguments(
            ...
            var __authorizations = global::Cartesia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PhoneNumbersProvisionSecurityRequirements,
                operationName: "PhoneNumbersProvisionAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Cartesia.PathBuilder(
                                path: "/agents/phone-numbers/provision",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePhoneNumbersProvisionRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Cartesia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PhoneNumbersProvision",
                                methodName: "PhoneNumbersProvisionAsync",
                                pathTemplate: "\"/agents/phone-numbers/provision\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPhoneNumbersProvisionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPhoneNumbersProvisionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Cartesia.ProvisionPhoneNumberResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Cartesia.AutoSDKHttpResponse<global::Cartesia.ProvisionPhoneNumberResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Cartesia.ProvisionPhoneNumberResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.ProvisionPhoneNumberResponse> PhoneNumbersProvisionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Cartesia.ProvisionPhoneNumberBody
            {
                Label = label,
                AgentId = agentId,
            };

            return await PhoneNumbersProvisionAsync(
                cartesiaVersion: cartesiaVersion,
                request: __request,
                requestOptions: requestOptions,

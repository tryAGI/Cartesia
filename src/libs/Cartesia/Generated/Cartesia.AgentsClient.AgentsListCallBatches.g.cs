...
namespace Cartesia
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement s_AgentsListCallBatchesSecurityRequirement0 =
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement[] s_AgentsListCallBatchesSecurityRequirements =
            new global::Cartesia.EndPointSecurityRequirement[]
            {                s_AgentsListCallBatchesSecurityRequirement0,
            };
        partial void PrepareAgentsListCallBatchesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Cartesia.AgentsListCallBatchesCartesiaVersion cartesiaVersion,
            ref string? agentId,
            ref string? startingAfter,
            ref string? endingBefore,
            ref int? limit);
        partial void PrepareAgentsListCallBatchesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Cartesia.AgentsListCallBatchesCartesiaVersion cartesiaVersion,
            string? agentId,
            string? startingAfter,
            string? endingBefore,
            int? limit);
        partial void ProcessAgentsListCallBatchesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentsListCallBatchesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.ListAgentCallBatchesResponse> AgentsListCallBatchesAsync(
        ...
        {
            var __response = await AgentsListCallBatchesAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Cartesia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Cartesia.AutoSDKHttpResponse<global::Cartesia.ListAgentCallBatchesResponse>> AgentsListCallBatchesAsResponseAsync(
            global::Cartesia.AgentsListCallBatchesCartesiaVersion cartesiaVersion = global::Cartesia.AgentsListCallBatchesCartesiaVersion.x20260814,
            string? agentId = default,
            string? startingAfter = default,
            string? endingBefore = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAgentsListCallBatchesArguments(
            ...
            var __authorizations = global::Cartesia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AgentsListCallBatchesSecurityRequirements,
                operationName: "AgentsListCallBatchesAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAgentsListCallBatchesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Cartesia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AgentsListCallBatches",
                                methodName: "AgentsListCallBatchesAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAgentsListCallBatchesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAgentsListCallBatchesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Cartesia.ListAgentCallBatchesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Cartesia.AutoSDKHttpResponse<global::Cartesia.ListAgentCallBatchesResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Cartesia.ListAgentCallBatchesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??

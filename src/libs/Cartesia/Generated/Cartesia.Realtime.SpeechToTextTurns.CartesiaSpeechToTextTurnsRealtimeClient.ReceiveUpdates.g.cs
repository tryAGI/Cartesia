...
namespace Cartesia.Realtime.SpeechToTextTurns
{
    public sealed partial class CartesiaSpeechToTextTurnsRealtimeClient
    {
        ...
        public async global::System.Collections.Generic.IAsyncEnumerable<global::Cartesia.Realtime.SpeechToTextTurns.ServerEvent> ReceiveUpdatesAsync(
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            while (_clientWebSocket.State == global::System.Net.WebSockets.WebSocketState.Open)
            {
                ...
                string json = global::System.Text.Encoding.UTF8.GetString(__messageBuffer.ToArray());
                    global::Cartesia.Realtime.SpeechToTextTurns.ServerEvent @event;
                    try
                    {
                        @event = (global::Cartesia.Realtime.SpeechToTextTurns.ServerEvent)global::System.Text.Json.JsonSerializer.Deserialize(json, typeof(global::Cartesia.Realtime.SpeechToTextTurns.ServerEvent), JsonSerializerContext)!;
                    }
            ...
            string rawText)
        {
            ...
            MessageReceived?.Invoke(
                this,
                new AutoSDKWebSocketMessageEventArgs<global::Cartesia.Realtime.SpeechToTextTurns.ServerEvent>(
                    @event,
                    rawText,
                    json));

            if (@event.Connected is { } __STTTurnsConnectedReceived)
            {
                STTTurnsConnectedReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Cartesia.Realtime.SpeechToTextTurns.STTTurnsConnected>(
                        __STTTurnsConnectedReceived,
                        rawText,
                        json));
            }
            if (@event.TurnStart is { } __STTTurnsTurnStartReceived)
            {
                STTTurnsTurnStartReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Cartesia.Realtime.SpeechToTextTurns.STTTurnsTurnStart>(
                        __STTTurnsTurnStartReceived,
                        rawText,
                        json));
            }
            if (@event.TurnUpdate is { } __STTTurnsTurnUpdateReceived)
            {
                STTTurnsTurnUpdateReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Cartesia.Realtime.SpeechToTextTurns.STTTurnsTurnUpdate>(
                        __STTTurnsTurnUpdateReceived,
                        rawText,
                        json));
            }
            if (@event.TurnEagerEnd is { } __STTTurnsTurnEagerEndReceived)
            {
                STTTurnsTurnEagerEndReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Cartesia.Realtime.SpeechToTextTurns.STTTurnsTurnEagerEnd>(
                        __STTTurnsTurnEagerEndReceived,
                        rawText,
                        json));
            }
            if (@event.TurnResume is { } __STTTurnsTurnResumeReceived)
            {
                STTTurnsTurnResumeReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Cartesia.Realtime.SpeechToTextTurns.STTTurnsTurnResume>(
                        __STTTurnsTurnResumeReceived,
                        rawText,
                        json));
            }
            if (@event.TurnEnd is { } __STTTurnsTurnEndReceived)
            {
                STTTurnsTurnEndReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Cartesia.Realtime.SpeechToTextTurns.STTTurnsTurnEnd>(
                        __STTTurnsTurnEndReceived,
                        rawText,
                        json));
            }
            if (@event.Error is { } __STTErrorResponseReceived)
            {
                STTErrorResponseReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::Cartesia.Realtime.SpeechToTextTurns.STTErrorResponse>(
                        __STTErrorResponseReceived,
                        rawText,
                        json));
            }
        }

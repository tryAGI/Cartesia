...
namespace Cartesia
{
    public partial class AgentToolsClient
    {
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement s_GetV1AgentsToolsSecurityRequirement0 =
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement[] s_GetV1AgentsToolsSecurityRequirements =
            new global::Cartesia.EndPointSecurityRequirement[]
            {                s_GetV1AgentsToolsSecurityRequirement0,
            };
        partial void PrepareGetV1AgentsToolsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? startingAfter,
            ref string? endingBefore,
            ref int? limit,
            ref global::Cartesia.GetV1AgentsToolsType? type,
            ref string? agentId,
            ref global::Cartesia.GetV1AgentsToolsCartesiaVersion cartesiaVersion);
        partial void PrepareGetV1AgentsToolsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? startingAfter,
            string? endingBefore,
            int? limit,
            global::Cartesia.GetV1AgentsToolsType? type,
            string? agentId,
            global::Cartesia.GetV1AgentsToolsCartesiaVersion cartesiaVersion);
        partial void ProcessGetV1AgentsToolsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetV1AgentsToolsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.ListManagedToolsV1Response> GetV1AgentsToolsAsync(
        ...
        {
            var __response = await GetV1AgentsToolsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Cartesia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Cartesia.AutoSDKHttpResponse<global::Cartesia.ListManagedToolsV1Response>> GetV1AgentsToolsAsResponseAsync(
            string? startingAfter = default,
            string? endingBefore = default,
            int? limit = default,
            global::Cartesia.GetV1AgentsToolsType? type = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetV1AgentsToolsArguments(
            ...
            var __authorizations = global::Cartesia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetV1AgentsToolsSecurityRequirements,
                operationName: "GetV1AgentsToolsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetV1AgentsToolsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Cartesia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetV1AgentsTools",
                                methodName: "GetV1AgentsToolsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetV1AgentsToolsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetV1AgentsToolsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Cartesia.ListManagedToolsV1Response.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Cartesia.AutoSDKHttpResponse<global::Cartesia.ListManagedToolsV1Response>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Cartesia.ListManagedToolsV1Response.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??

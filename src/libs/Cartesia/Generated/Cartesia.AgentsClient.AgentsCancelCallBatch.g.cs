...
namespace Cartesia
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement s_AgentsCancelCallBatchSecurityRequirement0 =
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement[] s_AgentsCancelCallBatchSecurityRequirements =
            new global::Cartesia.EndPointSecurityRequirement[]
            {                s_AgentsCancelCallBatchSecurityRequirement0,
            };
        partial void PrepareAgentsCancelCallBatchArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Cartesia.AgentsCancelCallBatchCartesiaVersion cartesiaVersion,
            ref string batchId);
        partial void PrepareAgentsCancelCallBatchRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Cartesia.AgentsCancelCallBatchCartesiaVersion cartesiaVersion,
            string batchId);
        partial void ProcessAgentsCancelCallBatchResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentsCancelCallBatchResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.AgentCallBatch> AgentsCancelCallBatchAsync(
            string batchId,
        ...
        {
            var __response = await AgentsCancelCallBatchAsResponseAsync(
                batchId: batchId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Cartesia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Cartesia.AutoSDKHttpResponse<global::Cartesia.AgentCallBatch>> AgentsCancelCallBatchAsResponseAsync(
            string batchId,
            global::Cartesia.AgentsCancelCallBatchCartesiaVersion cartesiaVersion = global::Cartesia.AgentsCancelCallBatchCartesiaVersion.x20260814,
            global::Cartesia.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAgentsCancelCallBatchArguments(
            ...
            var __authorizations = global::Cartesia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AgentsCancelCallBatchSecurityRequirements,
                operationName: "AgentsCancelCallBatchAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Cartesia.PathBuilder(
                                path: $"/agents/calls/batches/{batchId}/cancel",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAgentsCancelCallBatchRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Cartesia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AgentsCancelCallBatch",
                                methodName: "AgentsCancelCallBatchAsync",
                                pathTemplate: "$\"/agents/calls/batches/{batchId}/cancel\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAgentsCancelCallBatchResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAgentsCancelCallBatchResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);

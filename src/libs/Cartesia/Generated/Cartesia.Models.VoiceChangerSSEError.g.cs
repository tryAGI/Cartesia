...
namespace Cartesia
{
    ...
    public sealed partial class VoiceChangerSSEError
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Cartesia.JsonConverters.VoiceChangerSSEErrorTypeJsonConverter))]
        public global::Cartesia.VoiceChangerSSEErrorType Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VoiceChangerSSEError" /> class.
        /// </summary>
        /// <param name="done">
        /// Whether generation is complete. Always `true` for error events.
        /// </param>
        ...
        public VoiceChangerSSEError(
            ...
            string message,
            string requestId,
            global::Cartesia.VoiceChangerSSEErrorType type,
            string? errorCode,
            string? docUrl)
        {
            this.Type = type;

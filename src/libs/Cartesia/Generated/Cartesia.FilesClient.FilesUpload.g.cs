...
namespace Cartesia
{
    public partial class FilesClient
    {
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement s_FilesUploadSecurityRequirement0 =
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement[] s_FilesUploadSecurityRequirements =
            new global::Cartesia.EndPointSecurityRequirement[]
            {                s_FilesUploadSecurityRequirement0,
            };
        partial void PrepareFilesUploadArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Cartesia.FilesUploadCartesiaVersion cartesiaVersion,
            global::Cartesia.FilesUploadRequest request);
        partial void PrepareFilesUploadRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Cartesia.FilesUploadCartesiaVersion cartesiaVersion,
            global::Cartesia.FilesUploadRequest request);
        partial void ProcessFilesUploadResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessFilesUploadResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.File> FilesUploadAsync(
        ...
        {
            var __response = await FilesUploadAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Cartesia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Cartesia.AutoSDKHttpResponse<global::Cartesia.File>> FilesUploadAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Cartesia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_FilesUploadSecurityRequirements,
                operationName: "FilesUploadAsync");
                ...
                else
                {
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessFilesUploadResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.File> FilesUploadAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Cartesia.FilesUploadRequest
            {
                File = file,
                Filename = filename,
                Purpose = purpose,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::Cartesia.FilesUploadRequest
            {
                    ...
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Cartesia.File.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                }
                                catch (global::System.Exception __ex)
                                {
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Cartesia.File.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
                                        throw new global::System.InvalidOperationException("Response deserialization failed.");
                                }
                                catch (global::System.Exception __ex)
                                {

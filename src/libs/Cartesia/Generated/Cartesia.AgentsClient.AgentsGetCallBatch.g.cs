...
namespace Cartesia
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement s_AgentsGetCallBatchSecurityRequirement0 =
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement[] s_AgentsGetCallBatchSecurityRequirements =
            new global::Cartesia.EndPointSecurityRequirement[]
            {                s_AgentsGetCallBatchSecurityRequirement0,
            };
        partial void PrepareAgentsGetCallBatchArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Cartesia.AgentsGetCallBatchCartesiaVersion cartesiaVersion,
            ref string batchId);
        partial void PrepareAgentsGetCallBatchRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Cartesia.AgentsGetCallBatchCartesiaVersion cartesiaVersion,
            string batchId);
        partial void ProcessAgentsGetCallBatchResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentsGetCallBatchResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.AgentCallBatch> AgentsGetCallBatchAsync(
            string batchId,
        ...
        {
            var __response = await AgentsGetCallBatchAsResponseAsync(
                batchId: batchId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Cartesia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Cartesia.AutoSDKHttpResponse<global::Cartesia.AgentCallBatch>> AgentsGetCallBatchAsResponseAsync(
            string batchId,
            global::Cartesia.AgentsGetCallBatchCartesiaVersion cartesiaVersion = global::Cartesia.AgentsGetCallBatchCartesiaVersion.x20260814,
            global::Cartesia.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAgentsGetCallBatchArguments(
            ...
            var __authorizations = global::Cartesia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AgentsGetCallBatchSecurityRequirements,
                operationName: "AgentsGetCallBatchAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Cartesia.PathBuilder(
                                path: $"/agents/calls/batches/{batchId}",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAgentsGetCallBatchRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Cartesia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AgentsGetCallBatch",
                                methodName: "AgentsGetCallBatchAsync",
                                pathTemplate: "$\"/agents/calls/batches/{batchId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAgentsGetCallBatchResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAgentsGetCallBatchResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);

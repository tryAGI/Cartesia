...
namespace Cartesia
{
    public partial class UsageClient
    {
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement s_UsageAgentsSecurityRequirement0 =
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement[] s_UsageAgentsSecurityRequirements =
            new global::Cartesia.EndPointSecurityRequirement[]
            {                s_UsageAgentsSecurityRequirement0,
            };
        partial void PrepareUsageAgentsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Cartesia.UsageAgentsCartesiaVersion cartesiaVersion,
            ref global::System.DateTime? startTs,
            ref global::System.DateTime? endTs,
            ref global::Cartesia.UsageInterval? interval);
        partial void PrepareUsageAgentsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Cartesia.UsageAgentsCartesiaVersion cartesiaVersion,
            global::System.DateTime? startTs,
            global::System.DateTime? endTs,
            global::Cartesia.UsageInterval? interval);
        partial void ProcessUsageAgentsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUsageAgentsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.UsageAgentsResponse> UsageAgentsAsync(
        ...
        {
            var __response = await UsageAgentsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Cartesia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Cartesia.AutoSDKHttpResponse<global::Cartesia.UsageAgentsResponse>> UsageAgentsAsResponseAsync(
            global::Cartesia.UsageAgentsCartesiaVersion cartesiaVersion = global::Cartesia.UsageAgentsCartesiaVersion.x20260814,
            global::System.DateTime? startTs = default,
            global::System.DateTime? endTs = default,
            global::Cartesia.UsageInterval? interval = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Cartesia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UsageAgentsSecurityRequirements,
                operationName: "UsageAgentsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddOptionalParameter("start_ts", startTs?.ToString("yyyy-MM-ddTHH:mm:ssZ"))
                                .AddOptionalParameter("end_ts", endTs?.ToString("yyyy-MM-ddTHH:mm:ssZ"))
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Cartesia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UsageAgents",
                                methodName: "UsageAgentsAsync",
                                pathTemplate: "\"/usage/agents\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUsageAgentsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Cartesia.UsageAgentsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Cartesia.AutoSDKHttpResponse<global::Cartesia.UsageAgentsResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Cartesia.UsageAgentsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??

...
namespace Cartesia
{
    public partial class PhoneNumbersClient
    {
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement s_PhoneNumbersImportSecurityRequirement0 =
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement[] s_PhoneNumbersImportSecurityRequirements =
            new global::Cartesia.EndPointSecurityRequirement[]
            {                s_PhoneNumbersImportSecurityRequirement0,
            };
        partial void PreparePhoneNumbersImportArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Cartesia.PhoneNumbersImportCartesiaVersion cartesiaVersion,
            global::Cartesia.ImportPhoneNumberBody request);
        partial void PreparePhoneNumbersImportRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Cartesia.PhoneNumbersImportCartesiaVersion cartesiaVersion,
            global::Cartesia.ImportPhoneNumberBody request);
        partial void ProcessPhoneNumbersImportResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPhoneNumbersImportResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.PhoneNumberResponse> PhoneNumbersImportAsync(
        ...
        {
            var __response = await PhoneNumbersImportAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Cartesia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Cartesia.AutoSDKHttpResponse<global::Cartesia.PhoneNumberResponse>> PhoneNumbersImportAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePhoneNumbersImportArguments(
            ...
            var __authorizations = global::Cartesia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PhoneNumbersImportSecurityRequirements,
                operationName: "PhoneNumbersImportAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePhoneNumbersImportRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Cartesia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PhoneNumbersImport",
                                methodName: "PhoneNumbersImportAsync",
                                pathTemplate: "\"/agents/phone-numbers\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPhoneNumbersImportResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPhoneNumbersImportResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.PhoneNumberResponse> PhoneNumbersImportAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Cartesia.ImportPhoneNumberBody
            {
                Label = label,
                Number = number,
                Provider = provider,
            ...
            return await PhoneNumbersImportAsync(
                cartesiaVersion: cartesiaVersion,
                request: __request,
                requestOptions: requestOptions,

...
namespace Cartesia.Realtime
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Cartesia.Realtime.AutoSDKRetryOptions Retry { get; set; } = new global::Cartesia.Realtime.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Cartesia.Realtime.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Cartesia.Realtime.IAutoSDKHook>();
        ...
        public global::Cartesia.Realtime.AutoSDKClientOptions AddHook(
            global::Cartesia.Realtime.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Cartesia.Realtime.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Cartesia.Realtime.AutoSDKClientOptions UseAuthorizationProvider(
            global::Cartesia.Realtime.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Cartesia.Realtime.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Cartesia.Realtime.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Cartesia.Realtime.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Cartesia.Realtime.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Cartesia.Realtime.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Cartesia.Realtime.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Cartesia.Realtime.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Cartesia.Realtime.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Cartesia.Realtime.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Cartesia.Realtime.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Cartesia.Realtime.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Cartesia.Realtime.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Cartesia.Realtime.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Cartesia.Realtime.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Cartesia.Realtime.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Cartesia.Realtime.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Cartesia.Realtime.AutoSDKClientOptions clientOptions,
            global::Cartesia.Realtime.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Cartesia.Realtime.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Cartesia.Realtime.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Cartesia.Realtime.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Cartesia.Realtime.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Cartesia.Realtime.IAutoSDKHook, global::Cartesia.Realtime.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Cartesia.Realtime.AutoSDKHookContext context)
        {

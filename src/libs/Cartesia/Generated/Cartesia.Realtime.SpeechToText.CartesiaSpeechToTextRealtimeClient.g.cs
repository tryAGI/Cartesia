...
{
    /// <summary>
    /// Realtime speech transcription without turn detection<br/>
    /// &lt;Note&gt;<br/>
    ///   This endpoint relies on the `finalize` command to trigger transcription. See [Compare STT Endpoints](/use-the-api/stt/compare-endpoints) for details.<br/>
    /// &lt;/Note&gt;
    /// </summary>
    public sealed partial class CartesiaSpeechToTextRealtimeClient : global::System.IDisposable, global::System.IAsyncDisposable
    {
        /// <summary>
        /// Default WebSocket base URL.
        /// </summary>
        public const string DefaultBaseUrl = "wss://api.cartesia.ai/stt/websocket";
        ...
        /// </summary>
        public event global::System.EventHandler<AutoSDKWebSocketMessageEventArgs<global::Cartesia.Realtime.SpeechToText.ServerEvent>>? MessageReceived;
        /// <summary>
        /// Raised after a STTTranscriptResponse message is deserialized.
        /// </summary>
        public event global::System.EventHandler<AutoSDKWebSocketMessageEventArgs<global::Cartesia.Realtime.SpeechToText.STTTranscriptResponse>>? STTTranscriptResponseReceived;
        /// <summary>
        /// Raised after a STTFlushDoneResponse message is deserialized.
        /// </summary>
        public event global::System.EventHandler<AutoSDKWebSocketMessageEventArgs<global::Cartesia.Realtime.SpeechToText.STTFlushDoneResponse>>? STTFlushDoneResponseReceived;
        /// <summary>
        /// Raised after a STTDoneResponse message is deserialized.
        /// </summary>
        public event global::System.EventHandler<AutoSDKWebSocketMessageEventArgs<global::Cartesia.Realtime.SpeechToText.STTDoneResponse>>? STTDoneResponseReceived;
        /// <summary>
        /// Raised after a STTErrorResponse message is deserialized.
        /// </summary>
        public event global::System.EventHandler<AutoSDKWebSocketMessageEventArgs<global::Cartesia.Realtime.SpeechToText.STTErrorResponse>>? STTErrorResponseReceived;

        /// <summary>
        ///
        /// </summary>

        public global::System.Text.Json.Serialization.JsonSerializerContext JsonSerializerContext { get; set; } = global::Cartesia.Realtime.SpeechToText.SpeechToTextSourceGenerationContext.Default;
        ...
        /// <summary>
        /// Creates a new instance of the CartesiaSpeechToTextRealtimeClient.
        ...
        public CartesiaSpeechToTextRealtimeClient(
        ...
        private const string DefaultBaseUrlTemplate = "wss://api.cartesia.ai/stt/websocket";
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            {
                var __pathBuilder = new global::Cartesia.Realtime.SpeechToText.PathBuilder(
                    path: DefaultBaseUrl);
        ...
        /// <param name="model">ID of the model to use for transcription.  See [Models](/build-with-cartesia/stt/latest) for details.</param>
        /// <param name="sampleRate">The sample rate of the audio in Hz.</param>
        /// <param name="keyterm">Used by `ink-2` and `ink-preview` only.  Key terms to improve the recall of specific words and phrases.  Repeat the `keyterm` query parameter to pass multiple values, up to 100 keyterms totaling 1200 characters. To boost one multi-word phrase, join the words with `%20`.  Example: `?keyterm=Ink%202&amp;keyterm=Cartesia`  See [Keyterm prompting](/use-the-api/stt/keyterms) for details.</param>
        /// <param name="language">Used by `ink-whisper` models only.  The language of the input audio in ISO-639-1 format. Defaults to `en`.  See [Older models](/build-with-cartesia/stt/older-models#ink-whisper) for all options.</param>
        /// <param name="maxSilenceDurationSecs">Used by `ink-whisper` models only.  Maximum duration of silence (in seconds) before the API automatically finalizes the transcript.  Lower values will finalize transcripts more aggressively. Higher values allow for longer pauses within utterances.</param>
        /// <param name="minVolume">Used by `ink-whisper` models only.  Controls what is considered silence for automatic transcript finalization. Range: 0.0-1.0.  Lower values will pick up quiet audio. Higher values lead to more filtering for noisy audio.</param>
        ...
        public async global::System.Threading.Tasks.Task ConnectAsync(
            global::Cartesia.Realtime.SpeechToText.SpeechToTextApiVersion cartesiaVersion,
            global::Cartesia.Realtime.SpeechToText.SpeechToTextEncoding encoding,
            global::Cartesia.Realtime.SpeechToText.SpeechToTextModel model,
            int sampleRate,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            else
            {
                ...
                .AddOptionalParameter("min_volume", minVolume?.ToString())
                ;

...
namespace Cartesia
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement s_AgentsCreateOutboundCallSecurityRequirement0 =
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement[] s_AgentsCreateOutboundCallSecurityRequirements =
            new global::Cartesia.EndPointSecurityRequirement[]
            {                s_AgentsCreateOutboundCallSecurityRequirement0,
            };
        partial void PrepareAgentsCreateOutboundCallArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Cartesia.AgentsCreateOutboundCallCartesiaVersion cartesiaVersion,
            global::Cartesia.AgentOutboundCallRequest request);
        partial void PrepareAgentsCreateOutboundCallRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Cartesia.AgentsCreateOutboundCallCartesiaVersion cartesiaVersion,
            global::Cartesia.AgentOutboundCallRequest request);
        partial void ProcessAgentsCreateOutboundCallResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAgentsCreateOutboundCallResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.AgentOutboundCallResponse> AgentsCreateOutboundCallAsync(
        ...
        {
            var __response = await AgentsCreateOutboundCallAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Cartesia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Cartesia.AutoSDKHttpResponse<global::Cartesia.AgentOutboundCallResponse>> AgentsCreateOutboundCallAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAgentsCreateOutboundCallArguments(
            ...
            var __authorizations = global::Cartesia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AgentsCreateOutboundCallSecurityRequirements,
                operationName: "AgentsCreateOutboundCallAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAgentsCreateOutboundCallRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Cartesia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AgentsCreateOutboundCall",
                                methodName: "AgentsCreateOutboundCallAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAgentsCreateOutboundCallResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAgentsCreateOutboundCallResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Cartesia.AgentOutboundCallResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Cartesia.AutoSDKHttpResponse<global::Cartesia.AgentOutboundCallResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Cartesia.AgentOutboundCallResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.AgentOutboundCallResponse> AgentsCreateOutboundCallAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Cartesia.AgentOutboundCallRequest
            {
            ...
            return await AgentsCreateOutboundCallAsync(
                cartesiaVersion: cartesiaVersion,
                request: __request,
                requestOptions: requestOptions,

...
namespace Cartesia
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement s_GetV1AgentsByAgentIdSecurityRequirement0 =
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement[] s_GetV1AgentsByAgentIdSecurityRequirements =
            new global::Cartesia.EndPointSecurityRequirement[]
            {                s_GetV1AgentsByAgentIdSecurityRequirement0,
            };
        partial void PrepareGetV1AgentsByAgentIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string agentId,
            ref global::Cartesia.GetV1AgentsByAgentIdCartesiaVersion cartesiaVersion);
        partial void PrepareGetV1AgentsByAgentIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string agentId,
            global::Cartesia.GetV1AgentsByAgentIdCartesiaVersion cartesiaVersion);
        partial void ProcessGetV1AgentsByAgentIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetV1AgentsByAgentIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.ManagedAgentV1> GetV1AgentsByAgentIdAsync(
            string agentId,
        ...
        {
            var __response = await GetV1AgentsByAgentIdAsResponseAsync(
                agentId: agentId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Cartesia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Cartesia.AutoSDKHttpResponse<global::Cartesia.ManagedAgentV1>> GetV1AgentsByAgentIdAsResponseAsync(
            string agentId,
            global::Cartesia.GetV1AgentsByAgentIdCartesiaVersion cartesiaVersion = global::Cartesia.GetV1AgentsByAgentIdCartesiaVersion.x20260814,
            global::Cartesia.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetV1AgentsByAgentIdArguments(
            ...
            var __authorizations = global::Cartesia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetV1AgentsByAgentIdSecurityRequirements,
                operationName: "GetV1AgentsByAgentIdAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetV1AgentsByAgentIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Cartesia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetV1AgentsByAgentIdAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetV1AgentsByAgentIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetV1AgentsByAgentIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);

...
namespace Cartesia
{
    public partial class FilesClient
    {
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement s_FilesGetSecurityRequirement0 =
        ...
        private static readonly global::Cartesia.EndPointSecurityRequirement[] s_FilesGetSecurityRequirements =
            new global::Cartesia.EndPointSecurityRequirement[]
            {                s_FilesGetSecurityRequirement0,
            };
        partial void PrepareFilesGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Cartesia.FilesGetCartesiaVersion cartesiaVersion,
            ref string id);
        partial void PrepareFilesGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Cartesia.FilesGetCartesiaVersion cartesiaVersion,
            string id);
        ...
        public async global::System.Threading.Tasks.Task<global::Cartesia.File> FilesGetAsync(
            string id,
            global::Cartesia.FilesGetCartesiaVersion cartesiaVersion = global::Cartesia.FilesGetCartesiaVersion.x20260814,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Cartesia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Cartesia.AutoSDKHttpResponse<global::Cartesia.File>> FilesGetAsResponseAsync(
            string id,
            global::Cartesia.FilesGetCartesiaVersion cartesiaVersion = global::Cartesia.FilesGetCartesiaVersion.x20260814,
            global::Cartesia.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
                    ...
                    await global::Cartesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Cartesia.File.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Cartesia.AutoSDKHttpResponse<global::Cartesia.File>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Cartesia.File.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??

...
namespace Cartesia
{
    ...
    /// </summary>
    public static class SttTranscribeRequestLanguageExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this SttTranscribeRequestLanguage value)
        {
            return value switch
            {
        ...
        /// </summary>
        public static SttTranscribeRequestLanguage? ToEnum(string value)
        {
            return value switch
            {
